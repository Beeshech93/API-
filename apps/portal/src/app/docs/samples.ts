...
export function samples(base: string) {
  ...
  return {
    ...
    transaction: get("/api/v1/receive/moncash/payments/txn_xxxxx"),
    transferStatus: get("/api/v1/send/moncash/transfers/txn_xxxxx"),
    balance: get("/api/v1/receive/moncash/balance"),
