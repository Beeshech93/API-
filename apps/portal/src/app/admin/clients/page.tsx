...
interface Row { id: string; name: string; status: string; users: { email: string }[]; live_enabled: boolean }
...
export default function ClientsPage() {
  ...
  return (
    <div>
      ...
      <Table head={[t("auth.name"), t("auth.email"), t("admin.liveAccess"), t("common.status"), ""]} empty={t("common.empty")}>
        {rows.map((c) => (
          <tr key={c.id}>
